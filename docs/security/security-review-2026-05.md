...
`docs/security/threat-model.md` Claim 5.
...
- [ ] Add `make dev-pubkey-fixture` recipe that writes `fsbl/fixtures/dev_pubkey.bin`, set `FSBL_VENDOR_PUBKEY` to it for all dev Makefile recipes, document in `docs/hardware/dev-board-setup.md`.
