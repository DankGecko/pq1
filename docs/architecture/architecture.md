...
> - `docs/security/HARDENING.md`, `docs/security/production-security.md` — current threat model
>   and provisioning gates.
> - `docs/archive/handoff-modularity-refactor.md` — workspace-crate extraction map.
