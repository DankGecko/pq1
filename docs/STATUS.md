...
| Protocol | ProVerif (17 RESULTs) + Tamarin (6 lemmas) | `make proverif`/`make tamarin`; `4beebec7`,`118665bf`,`86291fd7`,`3f82f560`; **+`fw_update_authenticity.pv` 2026-06-18** (FW-update no-forgery, solidly proven; + a structural domain-tag gate that is present-not-adversarially-stressed; 2 RESULTs green) | **both provers re-run end-to-end** |
