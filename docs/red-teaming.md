...
> `docs/security-review-2026-05.md`, and `docs/threat-model.md`. Those reason about the
...
From `docs/threat-model.md`. The companion app and the entire Non-Secure (NS) world are
...
SE050 and recover the full seed — see `project_se_removal_invariant` and `docs/threat-model.md`.
...
flaky on the bench (see `docs/optiga-bringup-status.md`); a full encrypted round-trip on real
...
keep the admin-delete (DoS-wipe) path. `secure/src/se050/mod.rs`, `docs/se050-userid-pin-auth.md`.
...
`secure/src/measured_boot.rs`, `fsbl/`, `docs/measured-boot.md`.
...
`uart-console`/`sca-trigger`/etc. on production. `docs/HARDENING.md`.
...
- Invariants & threat model: `docs/threat-model.md`, `README.md`
...
- Security review + ship blockers: `docs/security-review-2026-05.md`, `docs/production-todo.md`, `docs/work-todo.md`
- SE bring-up: `docs/optiga-bringup-status.md`, `docs/optiga-brick-postmortem.md`, `docs/se050-userid-pin-auth.md`, `docs/se050-stress-harness.md`
- Hardening / boot: `docs/HARDENING.md`, `docs/measured-boot.md`, `docs/reproducible-builds.md`
