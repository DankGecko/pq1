...
fn production_and_e2e_partitions_are_exact_and_fail_closed() {
    ...
    assert_eq!(production.known_call_count, 4_615);
    assert_eq!(production.clear_contract_call_count, 1_325);
    assert_eq!(production.forced_eligible_count, 3_290);
    assert_eq!(production.forced_eligible_group_count, 560);
    assert_eq!(production.forced_eligible_set.len(), 33_336);
    ...
    assert_eq!(clear_view.group_count(), 342);
    assert_eq!(clear_bytes.len(), 17_628);
    ...
    assert_eq!(known_bytes.len(), 46_448);
