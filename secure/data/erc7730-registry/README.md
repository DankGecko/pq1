...
Checked-in curated receipt, verified against a fresh build by `--check`: **430 leaves**, **357,890-byte**
...
`fc7772981270fc22228d3c8bb2d1b80fad3915238921e35d9be271098084c685` binds upstream commit
