...
Checked-in curated receipt, verified against a fresh build by `--check`: **451 leaves**, **386,982-byte**
...
`073276cb021ed8ca68791c61f8e0a622950e6bffa2514a683e6089bcfb1dd38d` binds upstream commit
