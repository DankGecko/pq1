...
Checked-in curated receipt, verified against a fresh build by `--check`: **450 leaves**, **385,279-byte**
...
`e5b67a78696e7be930bcf75cc862b2e47f67b80ffe1c7d591e1a322a1070f439` binds upstream commit
