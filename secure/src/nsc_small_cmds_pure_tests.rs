...
fn negative_create2_factory_address_is_pinned() {
    ...
    let expected: [u8; 20] = [
        0xe8, 0xCE, 0x78, 0xCD, 0x97, 0x64, 0x97, 0x44, 0x7F, 0xF8, 0xB7, 0x6c, 0x71, 0xb5, 0x9a,
        0xE4, 0x2A, 0xf0, 0xd4, 0x52,
    ];
...
fn negative_create2_proxy_init_code_hash_is_pinned() {
    ...
    let expected: [u8; 32] = [
        0xac, 0x0c, 0x44, 0xb6, 0xd0, 0x6f, 0x67, 0x8e, 0xb3, 0x50, 0x42, 0x6f, 0x4d, 0x0d, 0x7a,
        0x89, 0xcc, 0x72, 0x9d, 0xcb, 0x15, 0x6d, 0xe3, 0x03, 0xfa, 0x77, 0xa7, 0x75, 0x2c, 0xcc,
        0x22, 0xb6,
    ];
