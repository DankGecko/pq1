...
pub static ERC7730_DESCRIPTORS_ROOT: [u8; 32] = [
    0xff, 0xe6, 0x92, 0xb9, 0xd6, 0x9d, 0xa3, 0x51,
    0x1e, 0x55, 0x54, 0x0e, 0xfc, 0x0a, 0x62, 0x70,
    0x0d, 0xaf, 0x99, 0x54, 0x7c, 0xf7, 0x4e, 0xa2,
    0x34, 0x5e, 0x04, 0x13, 0xa4, 0x7b, 0x0d, 0x77,
];

#[cfg(feature = "e2e-test")]
pub static ERC7730_DESCRIPTORS_ROOT: [u8; 32] = [
    0x7d, 0xe8, 0x0a, 0xe8, 0x94, 0xeb, 0xab, 0x00,
    0x0c, 0xf7, 0xa0, 0x71, 0xb8, 0x41, 0x35, 0x33,
    0xd0, 0x43, 0x69, 0x51, 0xdb, 0x43, 0xc8, 0x06,
    0x70, 0x67, 0x12, 0xd6, 0x07, 0x04, 0xfc, 0xeb,
];

#[cfg(not(feature = "e2e-test"))]
pub const ERC7730_DESCRIPTOR_COUNT: usize = 412;
