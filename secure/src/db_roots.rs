...
pub static ERC7730_DESCRIPTORS_ROOT: [u8; 32] = [
    0x11, 0xe0, 0x01, 0x7a, 0xb0, 0xcb, 0xf3, 0x50,
    0xae, 0x83, 0xd2, 0x74, 0x02, 0xf1, 0xd1, 0xea,
    0x95, 0xe7, 0x6e, 0x9c, 0xdb, 0x2a, 0x8a, 0x37,
    0x78, 0xc7, 0x62, 0x71, 0xf8, 0x04, 0x19, 0x20,
];
...
#[cfg(not(feature = "e2e-test"))]
pub const ERC7730_DESCRIPTOR_COUNT: usize = 399;
...
pub const ERC7730_FORCED_ELIGIBLE_GROUP_COUNT: usize = 555;
#[cfg(all(not(feature = "e2e-test"), feature = "erc7730-forced-blind"))]
pub const ERC7730_FORCED_ELIGIBLE_TUPLE_COUNT: usize = 3253;
#[cfg(all(not(feature = "e2e-test"), feature = "erc7730-forced-blind"))]
#[used]
#[no_mangle]
#[link_section = ".pqsigner.erc7730_forced_eligible"]
pub static PQSIGNER_ERC7730_FORCED_ELIGIBLE_SET: [u8; 33008] =
...
pub static PQSIGNER_ERC7730_CATALOGUE_STATUS: [u8; 256] = [
    ...
    0x00, 0x00, 0x01, 0x8f, 0x00, 0x05, 0x44, 0x53,
    0x00, 0x00, 0x11, 0xeb, 0x00, 0x00, 0x40, 0x00,
    0x11, 0xe0, 0x01, 0x7a, 0xb0, 0xcb, 0xf3, 0x50,
    0xae, 0x83, 0xd2, 0x74, 0x02, 0xf1, 0xd1, 0xea,
    0x95, 0xe7, 0x6e, 0x9c, 0xdb, 0x2a, 0x8a, 0x37,
    0x78, 0xc7, 0x62, 0x71, 0xf8, 0x04, 0x19, 0x20,
    0x8a, 0x11, 0x99, 0xda, 0x25, 0x1f, 0xa6, 0xff,
    0xe1, 0x97, 0xb4, 0xe4, 0xac, 0x11, 0xd6, 0x00,
    0xce, 0x9e, 0xb7, 0x57, 0x6d, 0x34, 0x31, 0xdf,
    0x44, 0x88, 0xef, 0xff, 0x3e, 0xb8, 0xda, 0x4b,
    ...
    0x22, 0xea, 0x38, 0xf0, 0x7f, 0x74, 0xae, 0xc8,
    0xf2, 0x19, 0xda, 0x5b, 0xb5, 0x77, 0x41, 0x37,
    0x84, 0xe8, 0x77, 0xc5, 0xa9, 0xfb, 0x4a, 0x45,
    0xec, 0x6d, 0x88, 0x3c, 0x35, 0x05, 0x8d, 0xe6,
