...
pub static ERC7730_DESCRIPTORS_ROOT: [u8; 32] = [
    0xa2, 0x09, 0x40, 0xba, 0x4d, 0x92, 0xb2, 0xdb,
    0xa1, 0xf8, 0x0e, 0xfd, 0xbe, 0x61, 0x51, 0x96,
    0xae, 0xde, 0x1c, 0x89, 0x3e, 0xb0, 0xa2, 0x5e,
    0x68, 0x04, 0x4b, 0x75, 0xdd, 0xe9, 0xb1, 0x0d,
];

#[cfg(feature = "e2e-test")]
pub static ERC7730_DESCRIPTORS_ROOT: [u8; 32] = [
    0xd3, 0xac, 0xdc, 0x06, 0x50, 0x10, 0x7d, 0xcc,
    0xa3, 0x3d, 0x66, 0x26, 0x41, 0xe8, 0x79, 0xe3,
    0x28, 0x14, 0x31, 0xfd, 0x41, 0xdc, 0xc5, 0x0a,
    0x97, 0xb7, 0x0c, 0xe1, 0x48, 0xaf, 0x07, 0xc5,
];
...
#[cfg(feature = "e2e-test")]
pub const ERC7730_DESCRIPTOR_COUNT: usize = 10;
