(* MUST-FAIL CONTROL for BadEncStep4.ec -- grind invariant without the head/filter conjunct; must fail in query_eq_badenc
...
(* ==========================================================================
   ...
   NEGATIVE CONTROLS -- FIVE, ALL MUST FAIL, ALL DO.  Regenerate with
   `./mkctl4.sh`, run with `./runctl.sh S4CtlA S4CtlB S4CtlC S4CtlD S4CtlE`,
   receipts in `controls/S4Ctl?.out`.  Each deletes exactly ONE fact and leaves
   every intro arity unchanged.  NONE produces a `.eco`.
