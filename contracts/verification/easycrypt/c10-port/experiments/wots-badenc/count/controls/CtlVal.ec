...
lemma kernelT : nth 0 (runs 8 fu43 (vinit fs205)) 0 = 22169393903687611906220091621190388.
proof. by []. qed.

(* MUST-FAIL NEGATIVE CONTROL -- value perturbed by +1. *)
lemma ctl_val : count_ds 43 8 205 = 22169393903687611906220091621190389.
proof.
have ge0_8 : 0 <= 8.
+ by [].
by rewrite -size_fu43 -size_fs205 (count_ds_kernel 8 fu43 fs205 ge0_8) kernelT.
qed.
