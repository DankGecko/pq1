...
apply (interactive_D1_MA (R_MEUFGCMAWOTSC_EUFNAGCMA_C(A_ht)) &m hc hembdisj hencb).
...
have hleaf := leaf_reduction_MEUFGCMAWOTSC_bound A_ht &m hc hembdisj hencb
...
proof.
move=> hc hembdisj hencb hdf8n hdflen hdf2 A_wf_ht allnchads.
have hcomp := seam_branch1_leaf_composed A_ht &m hc hembdisj hencb
                hdf8n hdflen hdf2 A_wf_ht allnchads.
...
have h1 := seam_branch1_lifted_to_REAL A_ht &m hc hembdisj hencb
             hdf8n hdflen hdf2 A_wf_ht allnchads.
...
move: (MEUFGCMA_WOTSTWESNPRF (R_int_WOTSTW(R_MEUFGCMAWOTSC_EUFNAGCMA_C(A_ht))) _ _ &m)
      (EUFNAGCMA_FLSLXMSSMTTWCESNPRF A_ht &m hc hembdisj hencb hdf8n hdflen hdf2
...
apply (leaf_reduction_MEUFGCMAWOTSC_bound A_ht &m hc hembdisj hencb h1 h2 h3).
conseq hA => //.
by move=> &hr _ tws_ma; apply (all_in_thfc4_neq_dfC tws_ma h1 h2 h3 h4).
qed.
...
apply (leaf_reduction_MEUFGCMAWOTSC_bound_members4 (R_top(F)) &m hc hembdisj hencb h1 h2 h3 h4).
