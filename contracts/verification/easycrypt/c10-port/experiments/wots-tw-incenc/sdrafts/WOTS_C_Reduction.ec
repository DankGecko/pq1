...
module type Adv_EUFNACMA_WOTSC(OC : STCRC_WC.Col.Oracle_THFC) = {
  ...
  proc forge(pk : pkWOTSTW, sig : sigWOTS * cntr) : msgWOTS * (sigWOTS * cntr) {}
}.
...
lemma sign_ctr (sk0 : skWOTS * pseed * adrs) (m0 : msgWOTS) :
...
equiv sign_eqs (sk0 : skWOTS * pseed * adrs) (m0 : msgWOTS) : WOTS_C_ES.sign ~ WOTS_C_ES.sign :
  ={arg} /\ sk{2} = sk0 /\ m{2} = m0
...
lemma sign_ctr2 (ps0 : pseed) (ad0 : adrs) (m0 : msgWOTS) :
  hoare[WOTS_C_ES.sign :
          sk.`2 = ps0 /\ sk.`3 = ad0 /\ m = m0 ==> res.`2 = grindC ps0 ad0 m0].
proof. proc; while (counter = grindC ps0 ad0 m0); by auto. qed.

equiv sign_eqs2 (ps0 : pseed) (ad0 : adrs) (m0 : msgWOTS) : WOTS_C_ES.sign ~ WOTS_C_ES.sign :
...
lemma grindC_E (ps0 : pseed) (ad0 : adrs) (m0 : msgWOTS) :
...
lemma grindC_filter (ps0 : pseed) (ad0 : adrs) (m0 : msgWOTS) :
  grindC ps0 ad0 m0
  = head witness
...
lemma signC_TW (ps0 : pseed) (ad0 : adrs) (m0 : msgWOTS) :
...
lemma verifyC_TW (psA : pseed) (adA : adrs) (mA : msgWOTS) (cA : cntr) :
  (forall (p : pseed) (a : adrs) (x : msgWOTS) (c : cntr),
     encode_msgWOTS_C p a x c = encode_msgWOTS (ThC p a x c)) =>
