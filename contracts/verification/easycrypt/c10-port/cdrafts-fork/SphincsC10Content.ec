...
+ have h1 : 0%r < mu1 ddgstblock (ThC witness witness witness cc0).
  (* TARGETED, not smt(@Distr) (2026-08-04 audit) -- see the split copy. *)
  + have := FTWES.ddgstblock_fu (ThC witness witness witness cc0); smt(supportP ge0_mu).
